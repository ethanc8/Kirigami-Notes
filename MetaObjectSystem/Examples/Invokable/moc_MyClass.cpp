...
QT_MOC_LITERAL(1, 8, 12), // "didSomething"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 14), // "onDidSomething"
QT_MOC_LITERAL(4, 37, 11) // "doSomething"

    },
    "MyClass\0didSomething\0\0onDidSomething\0"
    "doSomething"
};
...
void MyClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->didSomething((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->onDidSomething((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: { int _r = _t->doSomething((*reinterpret_cast< int(*)>(_a[1])));
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyClass::didSomething)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyClass::didSomething(int _t1)
{
